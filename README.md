...
- **Hurwitz zeta function** ("*src/lib/java/math/complex/functions/complex_hurwitz_zeta_function.java*") - One of zeta functions. It's approximation works for all *s* and for *a* with real part grater than one. It's approximation is not exactly precise. It's precision is about *1/2*, so you get answer *0.5* larger. You can read more on wikipedia: *https://en.wikipedia.org/wiki/Hurwitz_zeta_function*. I used this formula for calculating: *https://functions.wolfram.com/ZetaFunctionsandPolylogarithms/Zeta2/07/01/01/01/0002/*
