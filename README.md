...
- **Trigamma function** ("*src/lib/math/complex/functions/complex_trigamma_function.java*") - Second polygamma function. It is calculated with series. You can read more on wikipedia: *https://en.wikipedia.org/wiki/Trigamma_function*.
